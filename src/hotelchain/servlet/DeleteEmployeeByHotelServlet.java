...
@WebServlet(urlPatterns = { "/deleteEmployeeByHotel" })
public class DeleteEmployeeByHotelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public DeleteEmployeeByHotelServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			DBUtils.deleteEmployeeByHotel(conn, emp.getSin());
