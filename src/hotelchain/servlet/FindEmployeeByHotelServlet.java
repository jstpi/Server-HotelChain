...
@WebServlet(urlPatterns = { "/findEmployeeByHotel" })
public class FindEmployeeByHotelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public FindEmployeeByHotelServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			employee = DBUtils.findEmployeeByHotel(conn, hotel.getHotel_id());
